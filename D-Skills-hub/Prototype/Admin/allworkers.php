...
if (isset($_GET['del_workerId'])) {
	...
	$delete = "delete from workers where workerId='$id'";
			...
			<div class="col-md-10">
				<div class="card">
					<div class="card-header py-3">
						<center> <b> ALL AVAILABLE SKILLED WORKERS </b></center>
					</div>
					<div class="card-body">
						<table class="table table-borderless">
							...
							<?php while ($fetch_worker_info = mysqli_fetch_assoc($rs_coder)) { ?>
								<tr>
									...
									<td><a href="edit_worker.php?workerId=<?php echo $fetch_worker_info['workerId'];  ?>" class="btn btn-block btn-warning">EDIT</a></td>
									<td><a href="?del_workerId=<?php echo $fetch_worker_info['workerId'];  ?>" class="btn btn-block btn-danger">DELETE</a></td>
								</tr>
							<?php } ?>
						</table>
