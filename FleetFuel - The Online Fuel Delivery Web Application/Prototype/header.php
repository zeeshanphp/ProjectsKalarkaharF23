			...
			<div class="col-md-12">
				<ul class="nav nav-fill py-2 bg-primary">
					...
					<?php if (empty($_SESSION['userId'])) { ?>
						...
						<li class="nav-item br ml-3"><a href="Manager/" class="nav-link text-white">STATION LOGIN</a></li>
					...
					<?php } else { ?>
						<li class="nav-item br ml-3"><a href="profile.php" class="nav-link text-white">PROFILE</a></li>
