                ...
                <table class="table">
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle;"> <a href="view_members.php?branch=<?php echo $row['branchId'] ?>" class="btn btn-success bg-gradient rounded">View Branch Members</a> </td>
