...
if (isset($_POST['add_user'])) {
    ...
    $city = $_POST['ucity'];
    $query = "insert into  employers(username,fullname,password,email,phone,city) values('$username','$fullname','$pass','$email','$phone','$city')";
    mysqli_query($conn, $query);
    $message = "<b>Employer Registered Successfully &nbsp  <a href='index.php'>Go To Login Page</a> </b>";
}
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="text-primary">
                                    <center><b>REGISTER EMPLOYER</b></center>
                                </h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td><input type="submit" name="add_user" class="btn-primary bg-gradient btn w-100" value="Register As Employer" /></td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
