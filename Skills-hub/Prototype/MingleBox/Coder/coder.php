    	...
    	<div class="row">
    		<div id="" class="col-md-2">					
    			<ul class="nav nav-pills nav-stacked">
    				<li  class="active"><a href="viewInfo.php">VIEW INFO</a></li><br>
			...
			<div class="col-md-2">
				<img src="images/<?php echo $fetch_coder_info['image'];?>" alt="please upload you photo" height="300px" width="300px" />  
			</div>
    </div>
