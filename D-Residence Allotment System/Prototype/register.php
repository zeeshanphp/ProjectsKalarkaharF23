...
if (isset($_POST['add_user'])) {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        $query = "insert into  teanant(username,fullname,password,email,phone,city) values('$username','$fullname','$pass','$email','$phone','$city')";
        if (mysqli_query($conn, $query)) {
            $message = " <b> Teanant Registered Successfully &nbsp  &nbsp <a href='login.php'>Go To Login Page</a> </b>";
        }
    } else {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td></td>
                            <td><input type="submit" name="add_user" class="cust-btn-in btn w-100" value="Register As User" /></td>
                        </tr>
                    </table>
                </div>
            </div>
