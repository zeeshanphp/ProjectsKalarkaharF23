...
if (isset($_POST['add_user'])) {
    ...
    $city = $_POST['ucity'];
    $query = "insert into  owners(username,fullname,password,email,phone,city) values('$username','$fullname','$pass','$email','$phone','$city')";
    mysqli_query($conn, $query);
    $message = "<b>Owner Registered Successfull &nbsp  <a href='index.php'>Go To Login Page</a> </b>";
}
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2 class="text-primary">
                                    <center><b>REGISTER OWNER</b></center>
                                </h2>
                            </div>
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td><input type="submit" name="add_user" class="btn-primary bg-gradient btn w-100" value="Register As User" /></td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
